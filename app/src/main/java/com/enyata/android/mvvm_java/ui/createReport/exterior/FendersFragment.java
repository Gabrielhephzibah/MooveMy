...
public class FendersFragment extends Fragment {
    ...
    public FendersFragment(){
        //leave it empty
    }

    public static FendersFragment newInstance() {
        return new FendersFragment();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK) {
            ...
            takePicture.pictureCaptureNew(imageBitmap,FendersFragment.this,firstImage,secondImage,thirdImage,progressBar,getActivity(),imageDataArray);
