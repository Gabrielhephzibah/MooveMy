...
//      MediaManager.init(getActivity().getApplicationContext(), config);
    ...
    public void saveReport() {
        ...
        VehicleCollection.Request suspensionPerf = new VehicleCollection.Request("suspension performance", result, status);
        createReportViewModel.saveReportToLocalStorage(suspensionPerf);
