...
//      MediaManager.init(getActivity().getApplicationContext(), config);
    ...
    public void saveReport() {
        ...
        VehicleCollection.Request transmissionShift = new VehicleCollection.Request("transmission shift", result, status);
        createReportViewModel.saveReportToLocalStorage(transmissionShift);
