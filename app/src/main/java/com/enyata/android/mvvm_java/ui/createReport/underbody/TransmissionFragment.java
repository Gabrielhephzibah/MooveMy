...
//        MediaManager.init(getActivity().getApplicationContext(), config);
    ...
    public void saveReport() {
        ...
        VehicleCollection.Request transmisssion = new VehicleCollection.Request("transmission", result, status);
        createReportViewModel.saveReportToLocalStorage(transmisssion);
