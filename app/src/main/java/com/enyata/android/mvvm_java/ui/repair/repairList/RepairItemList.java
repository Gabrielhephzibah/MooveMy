...
public class RepairItemList implements Serializable {
    ...
    public RepairItemList(String mooveId, String year, String make, String model,String vehicleId,String id) {
