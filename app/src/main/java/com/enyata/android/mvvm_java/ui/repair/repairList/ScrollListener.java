...
public class ScrollListener extends RecyclerView.OnScrollListener {
    ...
    private OnLoadMoreListenerr listener;
    ...
    public ScrollListener(LinearLayoutManager linearLayoutManager, OnLoadMoreListenerr listener) {
    ...
    public interface OnLoadMoreListenerr {
        void onLoadMore();
    }
